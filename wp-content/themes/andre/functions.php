...
function twentyseventeen_widgets_init() {
    ...
    register_sidebar(array(
        'name' => __('Footer Column 1', 'twentyseventeen'),
        'id' => 'sidebar-2',
    ...
    register_sidebar(array(
        'name' => __('Footer Column 2', 'twentyseventeen'),
        'id' => 'sidebar-3',
        'description' => __('Add widgets here to appear in your footer.', 'twentyseventeen'),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget' => '</section>',
    ...
    register_sidebar(array(
        'name' => __('Footer Column 3', 'twentyseventeen'),
        'id' => 'sidebar-4',
        'description' => __('Add widgets here to appear in your footer.', 'twentyseventeen'),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget' => '</section>',
...
if (!defined('MODULE_PATH')):
    define('MODULE_PATH', get_template_directory() . '/custom-modules');
endif;
if (!defined('MODULE_URL')):
    define('MODULE_URL', get_template_directory_uri() . '/custom-modules');
endif;
 ...
 * --------------------------------------------
 */
require_once FRAMEWORK_PATH . '/framework-init.php';

/**
 * -------------------------------------------
 * THEME INFO:: GET THE THEME DATA
 * -------------------------------------------
 */
...
/**
 * --------------------------------------------
 * INIT METHOD:: INITIALIZE THE FRAMEWORK CLASS 
 * CALL THE FRAMEWORK INIT METHOD
 * --------------------------------------------
 */
themeFramework::init(array('theme_name' => $theme_data->get('Name'), 'theme_version' => $theme_data->get('Version'), 'theme_textdomain' => $theme_data->get('TextDomain')));

/* This is required for custom taxonomy page listing pagination */
