<?php
/*
 * Template Name: User Cart Template
 *
 */
get_header();
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-8">
                <div class="section-heading">
                    <h2><?php _e('Cart', THEME_TEXTDOMAIN); ?></h2>
                </div>

                <!-- Fetching User Cart Page -->
                <?php theme_template_part('user-cart/user-cart'); ?>
                <?php theme_template_part('user-cart/user-cart-mobile'); ?>
                <!-- End of Fetching User Cart Page -->
            </div>
        </div>
