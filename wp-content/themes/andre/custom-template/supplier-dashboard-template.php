<?php
/*
 * Template Name: Supplier Dashboard Template
 *
 */
get_header();
...
if ($userDetails->data['role'] == 'subscriber'):
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-8">
                <div class="section-heading">
                    <h2><?php _e('Dashboard', THEME_TEXTDOMAIN); ?></h2>
                </div>
                <!-- Fetching User Dashboard Page -->
                <?php theme_template_part('user-dashboard/user-dahsboard'); ?>
                <?php theme_template_part('user-dashboard/user-dahsboard-mobile'); ?>
            </div>
        </div>
