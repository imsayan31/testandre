<?php
/*
 * Template Name: Announcement Section Template
 *
 */
get_header();
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-8">
                <div class="section-heading">
                    <h2><?php _e('Announcement Management', THEME_TEXTDOMAIN); ?></h2>
                </div>
                <?php if (isset($_GET['announcement_id']) && $_GET['announcement_id'] != ''): ?>
                    <!-- Fetching User Announcement Editing Page -->
                    <?php theme_template_part('announcement-module/announcement-update'); ?>
                    <!-- End of Fetching User Announcement Editing Page -->
                <?php elseif (isset($_GET['announcement_renew']) && $_GET['announcement_renew'] != ''): ?>
                    <!-- Fetching User Announcement Renewal Page -->
                    <?php theme_template_part('announcement-module/announcement-renew'); ?>
                    <!-- End of Fetching User Announcement Renewal Page -->
                <?php else: ?>
                    <!-- Fetching User Announcement Creation Page -->
                    <?php theme_template_part('announcement-module/announcement-create'); ?>
                    <!-- End of Fetching User Announcement Creation Page -->
                <?php endif; ?>
