                    ...
                    <div>
                        <div class="product-single">
                            <div class="product-img">
                                <?php if ($userDetails->data['role'] == 'supplier'): ?>
                                <?php else: ?>
                                    <a href="javascript:void(0);" class="add-to-wishlist <?php echo ($isItemInWishlist == TRUE) ? 'wish-active' : ''; ?>" title="<?php _e('Add to wishlist', THEME_TEXTDOMAIN); ?>" data-pro="<?php echo base64_encode($eachFeaturedProduct->ID); ?>"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                <?php endif; ?>
                                <img src="<?php echo ($getProductImg[0]) ? $getProductImg[0] : 'https://via.placeholder.com/240x200'; ?>" alt="<?php echo $eachFeaturedProduct->post_title; ?>">
                                <?php if ($getProductDetails->data['is_simple'] == FALSE): ?>
                                    <div class="bundle-ann-icon">
