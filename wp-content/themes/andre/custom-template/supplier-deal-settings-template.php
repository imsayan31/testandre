<?php
/*
 * Template Name: Supplier Deal Settings Template
 *
 */
get_header();
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-8">
                <div class="section-heading">
                    <h2><?php _e('My Deal Settings', THEME_TEXTDOMAIN); ?></h2>
                </div>
                <!-- Fetching User Account Page -->
                <?php theme_template_part('supplier-deal-settings/supplier-deal-settings'); ?>
            </div>
        </div>
