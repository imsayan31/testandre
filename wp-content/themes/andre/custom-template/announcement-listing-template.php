...
/* 
 * Template Name: Announcement Listing Template
 * 
 */
...
<section class="block-row listing-product">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <?php theme_template_part('announcement-category-sidebar/announcement-category-sidebar'); ?>
            </div>
            <!-- End of Product Category Sidebar -->

            <!-- Product Listing -->
            <div class="col-sm-9">
                <?php theme_template_part('announcement-listing/announcement-listing'); ?>
            </div>
